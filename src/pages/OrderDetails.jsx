                    ...
                    {statusSteps.map((step, index) => (
                        <div key={step} className="flex items-center flex-1 min-w-[100px]">
                            <div className="flex flex-col items-center flex-1">
                                <div
                                    className={`size-8 rounded-full flex items-center justify-center text-xs font-bold ${index <= currentStepIndex
                            ...
                            {index < statusSteps.length - 1 && (
                                <div
                                    className={`h-0.5 flex-1 ${index < currentStepIndex ? "bg-primary-500" : "bg-gray-200 dark:bg-gray-800"
                                        }`}
                                />
                            )}
                        </div>
